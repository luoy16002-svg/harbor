...
These results apply to the 0.4.0 preview checked on 2026-09-07. They do not establish production readiness or carry over automatically to later builds.

| Check | Result | Scope |
| --- | --- | --- |
| Rust tests | 33 passed | Protocols, routing, packets, privacy, encrypted DNS, and adapter selection |
| Desktop checks | 31 passed | Imports, subscriptions, DPAPI, recovery state, isolation, and saved verification history |
...
| Control interface | 10 passed | Isolation, preflight, cancellation, stop, and atomic configuration changes |
| WPF workflows | 18 passed | Import, search, saved checks, tray controls, and loopback traffic |
