...
| Fixture | 0.8.0 | 0.13.0 |
| --- | --- | --- |
| AAAA delayed 1,200 ms; 7 connections | Median 1,226.14 ms; p95 1,231.19 ms; 7/7 completed | Median 77.47 ms; p95 79.19 ms; 7/7 completed |
| Eight unusable A records and usable IPv6; 3 connections | 0/3 completed | 3/3 completed; median 15.94 ms |
...
| Same 32-connection burst, connection time | Median 223.25 ms; p95 226.08 ms | Median 221.66 ms; p95 225.96 ms |
| Preflight with delayed AAAA; one sample | 1,205.63 ms | 17.69 ms |
...
The evidence records SHA-256 `9fab02f243337b51d50dccea2065b45cebcf1956bf851fafaf2c831af2ce1542` for the 0.8.0 engine and `ef80a57beeaa5a56c6542ac9936ff674ba93b1cf5724a3b1144a049e4f388804` for 0.13.0. These controlled faults establish behavior in the tested scenarios, not general internet latency, throughput, or long-term network reliability.
...
```powershell
python tests/connection_quality.py --engine dist/Harbor-0.13.0-preview-win-x64/harbor-engine.exe --baseline path/to/Harbor-0.8.0/harbor-engine.exe
```
